...
Функция находит все файлы текущей директории, далее переходит к считыванию данных из найденных файлов и по завершению чтения из последнего файла выводит результат.
